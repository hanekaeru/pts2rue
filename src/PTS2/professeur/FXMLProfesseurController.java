...
import PTS2.gestionquestion.FXMLGestionQuestionController;
import PTS2.modele.Utilisateur;
import PTS2.modererMessage.FXMLModererMessageController;
...
//        label.setText("Hello World!");
    ...
    */
    ...
    public void accederGererUtilisateur() throws IOException{
        FXMLLoader leLoader = new FXMLLoader (getClass().getResource("/PTS2/gererUtilisateur/FXMLGererUtilisateur.fxml") ) ;
        AnchorPane laPage = (AnchorPane) leLoader.load() ;
        Stage fenetreSecondaire= new Stage() ;
