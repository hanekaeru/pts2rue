package fr.iut.larochelle.gestionquestion;
...
public class FXMLGestionQuestionController implements Initializable {
    ...
    */
    ...
    public void accederAjouterQuestion() throws IOException{
        FXMLLoader leLoader = new FXMLLoader (getClass().getResource("/fr/iut/larochelle/gestionquestion/FXMLAjouterQuestion.fxml") ) ;
    ...
    */
    ...
    public void accederModifierQuestion() throws IOException{
        FXMLLoader leLoader = new FXMLLoader (getClass().getResource("/fr/iut/larochelle/gestionquestion/FXMLModifierQuestion.fxml") ) ;
        AnchorPane laPage = (AnchorPane) leLoader.load();
        Stage fenetreSecondaire= new Stage() ;
    ...
    */
    ...
    public void accederSupprimerQuestion() throws IOException{
        FXMLLoader leLoader = new FXMLLoader (getClass().getResource("/fr/iut/larochelle/gestionquestion/FXMLSupprimerQuestion.fxml") ) ;
        AnchorPane laPage = (AnchorPane) leLoader.load();
        Stage fenetreSecondaire= new Stage() ;
